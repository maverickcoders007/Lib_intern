...
{  
    ...
    var rl1=document.getElementById("rl1").value;
    ...
    if (this.readyState == 4 && this.status == 200) {
      if(this.responseText==="Done")
      {
          ...
          document.getElementById("suggform").style.visibility="hidden";
      }
    ...
    var parameters="rno="+rno+"&title="+title+"&author="+author+"&rl1="+rl1+"&rl2="+rl2;

    xhttp.open("POST", "sugginsert.php", true);
